...
class Test extends LitElement {
  ...
  pagescroll(e, x) {
    ...
    var element = document
      ...
      .shadowRoot.children[0].childNodes[19].childNodes[1].shadowRoot.getElementById(
        x
      );
  ...
  handleSubmit(e, stream){
    e.preventDefault();
    if(stream === 0){
      if(this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[1].childNodes[1].value !== ""){
        localStorage.setItem("stream1", this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[1].childNodes[1].value);
      }  else {
        localStorage.removeItem("stream1");
      }
    }
    if(stream === 1){
      if(this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[5].childNodes[1].value !== ""){
        localStorage.setItem("stream2", this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[5].childNodes[1].value);
      } else {
        localStorage.removeItem("stream2");
      }
    }
    if(stream === 2){
      if(this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[9].childNodes[1].value !== ""){
        localStorage.setItem("stream3", this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[9].childNodes[1].value);
      } else {
        localStorage.removeItem("stream3");
      }
    }
    if(stream === 3){
      if(this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[13].childNodes[1].value !== ""){
        localStorage.setItem("stream4", this.shadowRoot.childNodes[2].childNodes[3].childNodes[1].childNodes[13].childNodes[13].childNodes[1].value);
      } else {
      ...
      return html`
        <div class="page">
          ...
          <div class="settings-content">
            ...
            <br/>
            <div id="content" class="content">
            <div id="content">Hit <code id="key">ENTER</code> to save.</div>
            <br/>
...
customElements.get("app-test") || customElements.define("app-test", Test);
